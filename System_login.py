...
class RecMainWindow_login(RecMainWindow):
    ...
    def reset_user(self, logout=False):
        ...
        """
        # 设置默认的用户名和用户头像
        self.user_name = "Fredy"
        self.user_avatar = ":/icons/user.png"
        ...
        self.label_person_name.setText("Not Logged In")  # 设置用户名标签的文本为"未登录"
        ...
        if logout:
            ...
            self.login.pushButton_login.setText("Account Cancellation")
    ...
    def toggle_reset_avatar(self):
        ...
        self.login.pushButton_reg.setText("Modify Avatar")  # 设置注册按钮的文本为"修改头像"
