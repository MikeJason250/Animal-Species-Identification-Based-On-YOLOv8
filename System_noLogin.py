...
class RecMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        QWindowCtrls(self, exit_title="Stray animal recognition application",  # 退出确认框标题
                     exit_message='Exit Program？',  # 退出确认框text
    ...
    def toggle_table_review(self, row, col):
        ...
        try:
            ...
            self.label_display.setText('The current screen cannot be reproduced!')  # 当前画面无法重现，请点选图片的识别记录！
    ...
    def handle_camera_opened(self):
        ...
        # 绘制初始的垂直条形图
        self.textEdit_camera.setText('Real-time camera started')  # 在摄像头文本框中显示摄像头已启动的信息
        self.label_display.setText('正在启动识别系统...\n\nleading')  # 在标签中显示启动识别系统的提示信息
